    ...
    try:
      ...
      try:
        while True:
          ...
          minTemp8Bit = data.min()
          maxTemp8Bit = data.max()
          ...
          # data_msg.layout.dim[0].label = "width"
          # data_msg.layout.dim[0].size = 640
          # data_msg.layout.dim[0].stride = 640
          # data_msg.layout.dim[1].label = "height"
          # data_msg.layout.dim[1].size = 480
          # data_msg.layout.dim[1].stride = 480
          # data_msg.layout.data_offset = 0
          # data_msg.data_length = 640*480
          # data_msg.data = data
          
          # image_lepton_data_pub.publish(data)
          image_lepton_raw_pub.publish(CvBridge().cv2_to_imgmsg(data, "mono16"))
